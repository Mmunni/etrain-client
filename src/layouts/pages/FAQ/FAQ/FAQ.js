...
const FAQ = () => {
    return (
        <div>
          <h1 className='text-center my-5 faq-title'>
          Frequently Asked Questions
          </h1>
            <div className="container my-5">
            <Accordion defaultActiveKey={['0']} alwaysOpen>
      <Accordion.Item eventKey="0">
        <Accordion.Header className='faq'>Who should take an Online Course?</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="1">
        <Accordion.Header className='faq'>  I am a high school student, can I join?</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="2">
        <Accordion.Header className='faq'>Can I take more than one course at a time?</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="3">
        <Accordion.Header className='faq'>My payment did not go through. What do I do?</Accordion.Header>
        <Accordion.Body>
